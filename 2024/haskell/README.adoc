== :christmas_tree: Advent of Code 2024 - Haskell

My solutions to the https://adventofcode.com/2024[Advent of Code 2024]. Written in https://www.haskell.org[Haskell].
